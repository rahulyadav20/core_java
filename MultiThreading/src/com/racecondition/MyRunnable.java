...
public class MyRunnable implements Runnable {
	...
	public void run() {
		 ...
		 */
		  ...
		  synchronized (rgb) { rgb.setRGB(122,144, 155);
		  System.out.println(" MyRunnable Thread :: "+rgb.getColor()); }
		 ...
		 */
		  ...
		  try{ myLock.lock(); rgb.setRGB(122,144, 155);
		  System.out.println(" MyRunnable Thread ::  "+rgb.getColor()); }finally{
		  myLock.unlock(); }
